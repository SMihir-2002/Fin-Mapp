...
class _SingleSelectWidgetState extends State<SingleSelectWidget> {
  @override
  void initState() {
    answeredData[widget.singleSelectSchema["label"]] = null;
    super.initState();
  }
    ...
    return List.generate(
        ...
        (index) => Padding(
              ...
              child: RadioListTile(
                  ...
                  title: Text(
                      widget.singleSelectSchema["options"][index]["value"]),
                  value: widget.singleSelectSchema["options"][index]["value"],
                  groupValue: groupVal,
                  onChanged: (val) {
                    setState(() {
                      groupVal = val;
                      answeredData[widget.singleSelectSchema["label"]] = val;
                      print(answeredData);
                    });
                  }),
            ));
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(widget.singleSelectSchema["label"], style: AppTexts.headerText),
          ...radioList()
        ],
      ),
    );
